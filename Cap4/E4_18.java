		...
		do{
			...
			if(i==1)
				if(c.isDigit(c))
						...
						correct = false;
			/*
			 *  Di seguito si gestisce la possibilità che venga inserito un numero
			 *  intero, quindi inizializzo il denominatore a 1 e salto la verifica
			 *  successiva settando i direttamente a 4
			 */
			if(i==2)
				if(!(c == '/') && !(c == ' ')) 
						correct = false;
